...
ELOS_mat <- function( pt, end_day, sub_condition, boot_n){
  ...
  label2 <- paste("Lower bound of 95% Conf. Int. for expected length of hospital stay")
  label3 <- paste("Upper bound of 95% Conf. Int. for expected length of hospital stay")
  label4 <- paste("Probability of being in the hospital at day", end_day)
  label5 <- paste("Standard error of probability of being in the hospital at day", end_day)
